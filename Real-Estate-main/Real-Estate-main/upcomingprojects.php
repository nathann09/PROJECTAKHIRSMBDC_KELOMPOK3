            ...
            <table class="table table-hover table-bordered">
                ...
                <tbody>
                    ...
                    while($x=mysqli_fetch_array($res, MYSQLI_ASSOC)) {
                        $q1="select nameorg from login_builder
where bid=".$x['bid']."";
                        $r1=$conn->query($q1);
                        ...
                        echo "<tr>";
                            ...
                            echo "<td>
                                    <button class='btn btn-primary btn-sm' onclick=\"editProject('".$x['upid']."')\">
                                        <i class='fa fa-edit'></i>
                                    </button>
                                    <button class='btn btn-danger btn-sm' onclick=\"deleteProject('".$x['upid']."')\">
    ...
    <script>
        ...
        function deleteProject(projectId) {
            if (confirm('Are you sure you want to delete this project?')) {
                // Redirect to delete page with project ID
